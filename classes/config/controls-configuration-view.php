 ...
 *
 * @class           ControlsConfiguration5View
 ...
 *
 */
class ControlsConfiguration5View extends WPDKConfigurationView {

  /**
   * Create an instance of ControlsConfiguration5View class
   *
   * @brief Construct
   *
   * @return ControlsConfiguration5View
   */
  public function __construct() {

    /* Get configuration data from model */
    $configuration = ControlsConfiguration5::init();
