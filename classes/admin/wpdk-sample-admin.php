...
class WPDKSamplePlugin5Admin extends WPDKWordPressAdmin {
   ...
   * @brief Init
   *
   * @param WPDKSamplePlugin5 $plugin The main class of this plugin.
   *
  ...
  public static function init( $plugin ) {
    ...
    if ( is_null( $instance ) ) {
      $instance = new WPDKSamplePlugin5Admin( $plugin );
    }
    return $instance;
  }
   ...
   * @brief Construct
   *
   * @param WPDKSamplePlugin5 $plugin Main class of your plugin
   *
   * @return WPDKSamplePlugin5Admin
   */
      ...
      'wpdk_sampleplugin' => array(
        ...
        'subMenus'   => array(
          ...
          array(
            ...
            'pageTitle'  => __( 'wpdk sample plugin #5 - Show Controls Configuration' ),
            ...
            'viewController' => 'ControlsConfiguration5ViewController',
          ),
